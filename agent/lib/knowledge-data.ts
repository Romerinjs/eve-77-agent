...
export const STATIC_KNOWLEDGE_DOCUMENTS: CachedDocument[] = [
  ...
  },
  {
    ...
    "description": "Servicios comerciales de 77 Studio: Campañas Meta Ads, Google Ads, Gestión Estratégica de Redes, Automatización Comercial con IA y Diseño Web orientado a conversión. Criterios de inversión mínima y perfil elegible.",
    "module": "12-portafolio-servicios",
    "route": "/servicios/portafolio",
    "whatsappMessage": "Hola 77 Studio 👋 Quisiera consultar sobre su portafolio de servicios y los requisitos para implementar una estrategia comercial.",
    "category": "servicios",
    "audience": "empresas",
    "keywords": [
    ...
    "content": "Portafolio Oficial de Servicios & Perfil Ideal de Cliente (ICP)En 77 Studio estructuramos servicios de consultoría e implementación digital diseñados exclusivamente para empresas que buscan escalabilidad comercial, captación constante de clientes y optimización operativa.1. Visión General y Estándares de InversiónInversión Mínima en Honorarios: Desde $500 USD mensuales (o $2.000.000 COP mensuales) en servicios de gestión y estrategia de agencia.Presupuesto Publicitario: Adicional e independiente de los honorarios de la agencia (pagado directamente por el cliente a las plataformas Meta y Google).Compromiso Formal: Todos los servicios se ejecutan bajo contrato formal de prestación de servicios.Política de Ventas: No garantizamos cifras fijas de ventas mágicas; los resultados dependen de la inversión publicitaria, la competitividad de la oferta y la efectividad del equipo de ventas del cliente.2. Descripción Detallada de Servicios2.1 Campañas de Publicidad en Meta Ads (Facebook & Instagram)Descripción: Servicio especializado en captación proactiva y masiva de prospectos calificados mediante anuncios altamente segmentados.Qué Incluye:Estructuración integral del funnel y campañas de adquisición / retargeting.Segmentación estratégica avanzada por audiencias y comportamiento de compra.Copywriting persuasivo y diseño de creatividades base de alto impacto.Optimización técnica diaria de presupuesto y conversiones (CAPI / Píxel).Reporte mensual ejecutivo de métricas y retorno de inversión.Perfil Ideal: Empresas con producto/servicio validado que ya hayan vendido previamente y deseen multiplicar su flujo de cotizaciones.2.2 Campañas de Publicidad en Google Ads (Búsqueda & Red de Display)Descripción: Captura de demanda activa e inmediata de usuarios que buscan soluciones o servicios específicos en Google.Qué Incluye:Investigación estratégica de palabras clave (Keyword Research) y términos de intención comercial.Configuración técnica profesional de grupos de anuncios, extensiones y pujas inteligentes.Optimización continua enfocada en costo por lead (CPL) y tasa de conversión.Informes periódicos de rendimiento y calidad de tráfico.Perfil Ideal: Negocios locales, empresas de servicios especializados, B2B y firmas con demanda activa existente.2.3 Gestión Estratégica de Redes Sociales & Posicionamiento de MarcaDescripción: Construcción de autoridad y presencia de marca mediante contenido visual y narrativo alineado estrictamente a objetivos comerciales.Qué Incluye:Planeación mensual de calendario editorial y pilares de contenido.Redacción estratégica de copies y diseño gráfico profesional.Gestión de publicaciones y dirección visual.Perfil Ideal: Empresas en etapa de consolidación de marca, marcas personales de alto nivel, proyectos inmobiliarios, hoteleros e industriales.2.4 Automatización Comercial con Inteligencia Artificial & CRMsDescripción: Implementación de sistemas automatizados y asistentes conversacionales inteligentes para acelerar el seguimiento, filtrado y cierre de prospectos.Qué Incluye:Diseño e implementación de flujos automatizados (n8n, Make, Zapier).Integración nativa con WhatsApp Business y sistemas de CRM (HubSpot, Zoho, Kommo, etc.).Configuración de agentes comerciales IA (SDRs) para precalificación y agendamiento 24/7.Optimización de procesos internos para evitar pérdida de prospectos por demora en respuesta.Perfil Ideal: Empresas con volumen constante de prospectos que buscan escalar su capacidad de atención sin disparar costos operativos.2.5 Diseño Web Estratégico Orientado a ConversiónDescripción: Sitios web diseñados como activos de venta directa, rápidos, elegantes y optimizados para convertir visitantes en clientes potenciales.Estructura Estándar del Sitio:Home: Presentación de propuesta de valor, llamado a la acción y prueba social.Quiénes Somos: Historia corporativa, valores, misión y equipo.Servicios: Desglose detallado de la oferta comercial.Contacto: Formulario optimizado y botón directo a WhatsApp.Integraciones Técnicas Incluidas:Google Site Kit, Google Analytics 4 (GA4) y Google Tag Manager.Píxel de Meta con API de Conversiones (CAPI) para seguimiento sin pérdida de datos.Optimización para velocidad y experiencia en smartphones (Mobile-First).Límites Técnicos: 77 Studio ofrece desarrollo web estratégico y landing pages comerciales; no desarrolla software personalizado ni arquitecturas a medida no comerciales.3. Servicios Que 77 Studio NO Prioriza❌ Diseño gráfico aislado sin estrategia de negocio ni embudo.❌ Desarrollo técnico complejo a medida sin enfoque comercial.❌ Manejo básico de redes sociales sin presupuesto publicitario.❌ Proyectos en etapa de idea sin presupuesto de inversión definido.4. Criterios de Elegibilidad del Cliente (ICP)Un cliente es apto para iniciar trabajo con 77 Studio si:Negocio Activo: Cuenta con operaciones activas y ventas comprobadas.Capacidad de Inversión: Puede invertir un mínimo de $500 USD mensuales en honorarios más presupuesto de pauta publicitaria.Capacidad Operativa: Cuenta con personal para responder rápidamente a los prospectos generados.Visión de Crecimiento: Busca una relación comercial estratégica de mediano y largo plazo.",
    "contentTruncated": false,
    "search": {
      "id": "12-portafolio-servicios",
      "slug": "servicios/portafolio-icp",
      ...
      "module": "12-portafolio-servicios",
      "title": "77 studio - portafolio oficial de servicios & perfil de cliente ideal (icp)",
      "description": "servicios comerciales de 77 studio: campanas meta ads, google ads, gestion estrategica de redes, automatizacion comercial con ia y diseno web orientado a conversion. criterios de inversion minima y perfil elegible.",
      "category": "servicios",
      "audience": "empresas",
      "keywords": [
        "portafolio 77 studio",
      ...
      "content": "portafolio oficial de servicios & perfil ideal de cliente (icp)en 77 studio estructuramos servicios de consultoria e implementacion digital disenados exclusivamente para empresas que buscan escalabilidad comercial, captacion constante de clientes y optimizacion operativa.1. vision general y estandares de inversioninversion minima en honorarios: desde $500 usd mensuales (o $2.000.000 cop mensuales) en servicios de gestion y estrategia de agencia.presupuesto publicitario: adicional e independiente de los honorarios de la agencia (pagado directamente por el cliente a las plataformas meta y google).compromiso formal: todos los servicios se ejecutan bajo contrato formal de prestacion de servicios.politica de ventas: no garantizamos cifras fijas de ventas magicas; los resultados dependen de la inversion publicitaria, la competitividad de la oferta y la efectividad del equipo de ventas del cliente.2. descripcion detallada de servicios2.1 campanas de publicidad en meta ads (facebook & instagram)descripcion: servicio especializado en captacion proactiva y masiva de prospectos calificados mediante anuncios altamente segmentados.que incluye:estructuracion integral del funnel y campanas de adquisicion / retargeting.segmentacion estrategica avanzada por audiencias y comportamiento de compra.copywriting persuasivo y diseno de creatividades base de alto impacto.optimizacion tecnica diaria de presupuesto y conversiones (capi / pixel).reporte mensual ejecutivo de metricas y retorno de inversion.perfil ideal: empresas con producto/servicio validado que ya hayan vendido previamente y deseen multiplicar su flujo de cotizaciones.2.2 campanas de publicidad en google ads (busqueda & red de display)descripcion: captura de demanda activa e inmediata de usuarios que buscan soluciones o servicios especificos en google.que incluye:investigacion estrategica de palabras clave (keyword research) y terminos de intencion comercial.configuracion tecnica profesional de grupos de anuncios, extensiones y pujas inteligentes.optimizacion continua enfocada en costo por lead (cpl) y tasa de conversion.informes periodicos de rendimiento y calidad de trafico.perfil ideal: negocios locales, empresas de servicios especializados, b2b y firmas con demanda activa existente.2.3 gestion estrategica de redes sociales & posicionamiento de marcadescripcion: construccion de autoridad y presencia de marca mediante contenido visual y narrativo alineado estrictamente a objetivos comerciales.que incluye:planeacion mensual de calendario editorial y pilares de contenido.redaccion estrategica de copies y diseno grafico profesional.gestion de publicaciones y direccion visual.perfil ideal: empresas en etapa de consolidacion de marca, marcas personales de alto nivel, proyectos inmobiliarios, hoteleros e industriales.2.4 automatizacion comercial con inteligencia artificial & crmsdescripcion: implementacion de sistemas automatizados y asistentes conversacionales inteligentes para acelerar el seguimiento, filtrado y cierre de prospectos.que incluye:diseno e implementacion de flujos automatizados (n8n, make, zapier).integracion nativa con whatsapp business y sistemas de crm (hubspot, zoho, kommo, etc.).configuracion de agentes comerciales ia (sdrs) para precalificacion y agendamiento 24/7.optimizacion de procesos internos para evitar perdida de prospectos por demora en respuesta.perfil ideal: empresas con volumen constante de prospectos que buscan escalar su capacidad de atencion sin disparar costos operativos.2.5 diseno web estrategico orientado a conversiondescripcion: sitios web disenados como activos de venta directa, rapidos, elegantes y optimizados para convertir visitantes en clientes potenciales.estructura estandar del sitio:home: presentacion de propuesta de valor, llamado a la accion y prueba social.quienes somos: historia corporativa, valores, mision y equipo.servicios: desglose detallado de la oferta comercial.contacto: formulario optimizado y boton directo a whatsapp.integraciones tecnicas incluidas:google site kit, google analytics 4 (ga4) y google tag manager.pixel de meta con api de conversiones (capi) para seguimiento sin perdida de datos.optimizacion para velocidad y experiencia en smartphones (mobile-first).limites tecnicos: 77 studio ofrece desarrollo web estrategico y landing pages comerciales; no desarrolla software personalizado ni arquitecturas a medida no comerciales.3. servicios que 77 studio no prioriza❌ diseno grafico aislado sin estrategia de negocio ni embudo.❌ desarrollo tecnico complejo a medida sin enfoque comercial.❌ manejo basico de redes sociales sin presupuesto publicitario.❌ proyectos en etapa de idea sin presupuesto de inversion definido.4. criterios de elegibilidad del cliente (icp)un cliente es apto para iniciar trabajo con 77 studio si:negocio activo: cuenta con operaciones activas y ventas comprobadas.capacidad de inversion: puede invertir un minimo de $500 usd mensuales en honorarios mas presupuesto de pauta publicitaria.capacidad operativa: cuenta con personal para responder rapidamente a los prospectos generados.vision de crecimiento: busca una relacion comercial estrategica de mediano y largo plazo."
    }
  },
  {
    ...
    "description": "Protocolo oficial de precalificación comercial para el Agente IA de 77 Studio: variables obligatorias, flujo de diagnóstico de 4 pasos, criterios de prospectos calificados vs no calificados y protocolo de Ruta de Comunidad.",
    ...
    "content": "Manual de Calificación Comercial (SDR Automatizado)El presente manual establece las directrices operativas, criterios de evaluación y protocolos de agendamiento que rigen el comportamiento del Agente Comercial IA (SDR) de 77 Studio SAS.1. Objetivo Exclusivo del Agente Comercial IALa función del agente comercial automatizado es estrictamente de triaje y calificación estratégica:✅ Calificar prospectos: Identificar el nivel de madurez y encaje de cada negocio.✅ Filtrar oportunidades reales: Asegurar que se cumplan los estándares de inversión mínima.✅ Agendar llamadas estratégicas por Google Meet: Coordinar la cita formal con el equipo humano de 77 Studio.[!IMPORTANT] El agente NO vende directamente, NO envía propuestas económicas cerradas, NO negocia honorarios ni firma contratos. Su único entregable es una llamada agendada con un prospecto 100% calificado.2. Las 8 Variables Obligatorias a DetectarDurante el diálogo, el agente debe recopilar y validar las siguientes 8 variables antes de proponer un agendamiento:Tipo de Negocio: Industria, sector o actividad principal.Ubicación Geográfica: Ciudad y país de operación.Estado del Negocio: Empresa activa con ventas previas vs. idea en papel.Objetivo Principal: Ventas directas, captación de leads calificados o posicionamiento de marca.Presupuesto Mensual Disponible: Capacidad de inversión mínima en marketing.Experiencia Previa: Si ha trabajado anteriormente con agencias o pauta publicitaria.Capacidad Operativa: Capacidad del cliente para atender y cerrar prospectos comerciales.Nivel de Urgencia: Plazo esperado para implementar la estrategia.3. Flujo de Diagnóstico Obligatorio (4 Pasos)El agente debe guiar la interacción en este orden secuencial:Paso 1 – Confirmar Negocio Activo: Validar que el prospecto esté operando comercialmente y cuente con facturación previa.Paso 2 – Confirmar Objetivo de Crecimiento: Identificar si busca escalar seriamente o solo \"probar a ver qué pasa\".Paso 3 – Validar Presupuesto: Confirmar explícitamente que cuenta con un mínimo de $500 USD mensuales (o $2.000.000 COP) para honorarios de agencia, más presupuesto adicional para pauta.Paso 4 – Confirmar Estructura de Ventas: Validar que cuente con equipo o capacidad para responder a los clientes potenciales generados.4. Criterios de Prospecto CALIFICADO (Apto para Agendamiento)Un prospecto es calificado cuando cumple la totalidad de estos requisitos:Tiene negocio activo con tracción comercial.Ha vendido anteriormente su producto o servicio.Dispone del presupuesto mínimo de $500 USD mensuales en honorarios.Demuestra seriedad, coherencia y deseo de crecimiento estructurado.Tiene capacidad para responder a nuevos clientes.Acción del Agente: Confirmar interés, proponer la llamada estratégica de 15 minutos por Meet, consultar disponibilidad horaria y formalizar la cita.5. Criterios de Prospecto NO CALIFICADO (No Agendar)El agente NO debe agendar si el prospecto:Está en etapa de idea o no tiene negocio activo.No cuenta con presupuesto mínimo de inversión ($500 USD).Busca resultados garantizados o asesoría técnica gratuita.Evita responder las preguntas de diagnóstico.Tiene expectativas irreales de ventas mágicas sin inversión.Acción del Agente: Responder con cortesía, no confrontar, no negociar descuentos y activar el Protocolo de Ruta de Comunidad.6. Manejo de Objeciones y Casos EspecíficosCaso 1: \"No tengo presupuesto ahora\"Directriz: Explicar que la publicidad y consultoría requieren inversión estructurada, dejando la puerta abierta para cuando cuenten con presupuesto. NUNCA ofrecer rebajas ni regatear.Caso 2: \"Solo quiero saber cuánto cobran\"Directriz: Explicar que cada estrategia se diseña a la medida según el tipo de negocio y canal, por lo que primero es indispensable entender su caso antes de definir la inversión.Caso 3: \"Ya trabajé con otra agencia y no funcionó\"Directriz: Mostrar empatía, explicar que el éxito depende de la combinación de estrategia, medición y estructura de cierre, y continuar con la calificación.7. Protocolo de Prospecto No Elegible (Ruta de Comunidad)Cuando un prospecto no califica por presupuesto o etapa temprana:Mantener Autoridad y Empatía: No rechazar de forma fría ni sonar arrogante.Posicionar a 77 Studio: Dejar una excelente percepción de profesionalismo.Compartir Recurso Educativo: Ofrecer la guía gratuita:\"En este momento puede que aún no sea el mejor punto para implementar campañas pagas de manera efectiva. Sin embargo, tenemos una guía gratuita donde explicamos 'Cómo Preparar tu Negocio Antes de Invertir en Publicidad Digital'. Te la comparto para que puedas estructurarte mejor y cuando estés listo, lo revisamos juntos.\"",
    "contentTruncated": false,
    "search": {
      "id": "13-calificacion-comercial",
      "slug": "audiencias/calificacion-comercial",
      ...
      "description": "protocolo oficial de precalificacion comercial para el agente ia de 77 studio: variables obligatorias, flujo de diagnostico de 4 pasos, criterios de prospectos calificados vs no calificados y protocolo de ruta de comunidad.",
      "category": "audiencias",
      "audience": "nuevos-clientes",
      "keywords": [
        "calificacion comercial",
      ...
      "content": "manual de calificacion comercial (sdr automatizado)el presente manual establece las directrices operativas, criterios de evaluacion y protocolos de agendamiento que rigen el comportamiento del agente comercial ia (sdr) de 77 studio sas.1. objetivo exclusivo del agente comercial iala funcion del agente comercial automatizado es estrictamente de triaje y calificacion estrategica:✅ calificar prospectos: identificar el nivel de madurez y encaje de cada negocio.✅ filtrar oportunidades reales: asegurar que se cumplan los estandares de inversion minima.✅ agendar llamadas estrategicas por google meet: coordinar la cita formal con el equipo humano de 77 studio.[!important] el agente no vende directamente, no envia propuestas economicas cerradas, no negocia honorarios ni firma contratos. su unico entregable es una llamada agendada con un prospecto 100% calificado.2. las 8 variables obligatorias a detectardurante el dialogo, el agente debe recopilar y validar las siguientes 8 variables antes de proponer un agendamiento:tipo de negocio: industria, sector o actividad principal.ubicacion geografica: ciudad y pais de operacion.estado del negocio: empresa activa con ventas previas vs. idea en papel.objetivo principal: ventas directas, captacion de leads calificados o posicionamiento de marca.presupuesto mensual disponible: capacidad de inversion minima en marketing.experiencia previa: si ha trabajado anteriormente con agencias o pauta publicitaria.capacidad operativa: capacidad del cliente para atender y cerrar prospectos comerciales.nivel de urgencia: plazo esperado para implementar la estrategia.3. flujo de diagnostico obligatorio (4 pasos)el agente debe guiar la interaccion en este orden secuencial:paso 1 – confirmar negocio activo: validar que el prospecto este operando comercialmente y cuente con facturacion previa.paso 2 – confirmar objetivo de crecimiento: identificar si busca escalar seriamente o solo \"probar a ver que pasa\".paso 3 – validar presupuesto: confirmar explicitamente que cuenta con un minimo de $500 usd mensuales (o $2.000.000 cop) para honorarios de agencia, mas presupuesto adicional para pauta.paso 4 – confirmar estructura de ventas: validar que cuente con equipo o capacidad para responder a los clientes potenciales generados.4. criterios de prospecto calificado (apto para agendamiento)un prospecto es calificado cuando cumple la totalidad de estos requisitos:tiene negocio activo con traccion comercial.ha vendido anteriormente su producto o servicio.dispone del presupuesto minimo de $500 usd mensuales en honorarios.demuestra seriedad, coherencia y deseo de crecimiento estructurado.tiene capacidad para responder a nuevos clientes.accion del agente: confirmar interes, proponer la llamada estrategica de 15 minutos por meet, consultar disponibilidad horaria y formalizar la cita.5. criterios de prospecto no calificado (no agendar)el agente no debe agendar si el prospecto:esta en etapa de idea o no tiene negocio activo.no cuenta con presupuesto minimo de inversion ($500 usd).busca resultados garantizados o asesoria tecnica gratuita.evita responder las preguntas de diagnostico.tiene expectativas irreales de ventas magicas sin inversion.accion del agente: responder con cortesia, no confrontar, no negociar descuentos y activar el protocolo de ruta de comunidad.6. manejo de objeciones y casos especificoscaso 1: \"no tengo presupuesto ahora\"directriz: explicar que la publicidad y consultoria requieren inversion estructurada, dejando la puerta abierta para cuando cuenten con presupuesto. nunca ofrecer rebajas ni regatear.caso 2: \"solo quiero saber cuanto cobran\"directriz: explicar que cada estrategia se disena a la medida segun el tipo de negocio y canal, por lo que primero es indispensable entender su caso antes de definir la inversion.caso 3: \"ya trabaje con otra agencia y no funciono\"directriz: mostrar empatia, explicar que el exito depende de la combinacion de estrategia, medicion y estructura de cierre, y continuar con la calificacion.7. protocolo de prospecto no elegible (ruta de comunidad)cuando un prospecto no califica por presupuesto o etapa temprana:mantener autoridad y empatia: no rechazar de forma fria ni sonar arrogante.posicionar a 77 studio: dejar una excelente percepcion de profesionalismo.compartir recurso educativo: ofrecer la guia gratuita:\"en este momento puede que aun no sea el mejor punto para implementar campanas pagas de manera efectiva. sin embargo, tenemos una guia gratuita donde explicamos 'como preparar tu negocio antes de invertir en publicidad digital'. te la comparto para que puedas estructurarte mejor y cuando estes listo, lo revisamos juntos.\""
    }
  },
  {
    ...
    "description": "Estándares conversacionales oficiales para la Asesora Comercial de 77 Studio (Sofía): apertura obligatoria, flujo guiado de 6 pasos, manejo de autoridad, emojis, respuestas concisas de 3 a 5 líneas y comportamientos prohibidos.",
    ...
    "search": {
      ...
      "description": "estandares conversacionales oficiales para la asesora comercial de 77 studio (sofia): apertura obligatoria, flujo guiado de 6 pasos, manejo de autoridad, emojis, respuestas concisas de 3 a 5 lineas y comportamientos prohibidos.",
      "category": "tecnologia",
      "audience": "nuevos-clientes",
      "keywords": [
        "guia conversacional",
  ...
  },
  {
    ...
    "description": "Árbol de decisión, variables críticas de evaluación, reglas de persistencia, condiciones de terminación y restricciones operativas absolutas para la integración del Agente Comercial IA.",
    ...
    "content": "Lógica de Decisión y Reglas Operativas (SDR Automatizado)Documento de especificación técnica y lógica de decisión para la orquestación del Agente Comercial IA de 77 Studio SAS en entornos de ejecución automatizados (n8n + Gemini / Eve Runtime).1. Principio Operativo GeneralEl sistema opera bajo una regla de triaje binaria:Si cumple con los criterios mínimos: Conducir hacia el agendamiento de una llamada estratégica por Meet con el equipo de consultoría humana.Si no cumple con los criterios mínimos: Activar el Protocolo de Ruta de Comunidad (guía educativa descargable) y cerrar la conversación cordialmente.2. Variables Críticas de EvaluaciónEl motor de decisión evalúa obligatoriamente las siguientes variables booleanas:| Variable | Tipo | Condición de Aprobación | | :--- | :--- | :--- | | negocio_activo | Booleano | SI (operando actualmente). | | ha_vendido_antes | Booleano | SI (producto/servicio probado). | | presupuesto_minimo | Booleano | SI (dispone de ≥ $500 USD / $2.000.000 COP mensuales en honorarios). | | capacidad_operativa | Booleano | SI (equipo disponible para responder prospectos). | | interes_crecimiento | Enum | ALTO (busca escalar y estructurar su captación). |3. Árbol de Decisión PrincipalCaso A: Negocio No Activo / En Etapa de IdeaCondición: negocio_activo == NO o ha_vendido_antes == NO.Acción: No agendar llamada. Redirigir a recurso educativo. Cerrar conversación con profesionalismo.Caso B: Presupuesto Insuficiente (< $500 USD)Condición: presupuesto_minimo == NO (confirma presupuesto menor a $500 USD / $2M COP).Acción: No negociar, no ofrecer descuentos ni tarifas reducidas. Activar Ruta de Comunidad y compartir guía descargable.Caso C: Negocio Activo + Presupuesto Elegible (Calificado)Condición: negocio_activo == SI && presupuesto_minimo == SI && interes == ALTO.Acción: Confirmar intención, proponer agendamiento por Meet, solicitar disponibilidad horaria y formalizar la cita con el equipo de 77 Studio.Caso D: Evasión de Preguntas de DiagnósticoCondición: El prospecto evita responder las preguntas de calificación o solo insiste en pedir precios sin contexto.Acción: Reintentar el diagnóstico un máximo de 2 veces. Si persiste la evasión, cerrar la conversación amablemente sin agendar.Caso E: Objeción por Malas Experiencias PasadasCondición: El prospecto manifiesta desconfianza o malas experiencias con agencias anteriores.Acción: Validar la preocupación con empatía, explicar brevemente el enfoque de medición y acompañamiento de 77 Studio, y retomar el flujo de calificación.4. Reglas de Persistencia y Límites de InteracciónReintentos Permitidos: Reformular una pregunta clave un máximo de 2 veces si la respuesta no es clara.Límite de Inactividad: No enviar más de 2 mensajes consecutivos si el prospecto no responde.Sin Presión: Jamás insistir ni rogar por un agendamiento.5. Condiciones de Terminación de la ConversaciónEl agente finaliza formalmente la interacción cuando:Se concreta el agendamiento de la reunión estratégica.Se entrega el recurso educativo de la Ruta de Comunidad.El prospecto deja de responder tras 2 intentos de seguimiento.El prospecto confirma explícitamente que no desea continuar.6. Restricciones Operativas AbsolutasEl agente TIENE PROHIBIDO:❌ Garantizar ventas, contratos cerrados o prometer retorno de inversión (ROI) fijo.❌ Discutir precios finales cerrados sin previo diagnóstico del equipo humano.❌ Negociar o rebajar los honorarios mínimos de $500 USD.❌ Enviar propuestas formales o contratos legales.❌ Extender conversaciones no comerciales fuera del alcance de 77 Studio.7. Pseudocódigo Operativo del Motor de Decisiónif (!negocio_activo || !ha_vendido_antes) { activarRutaComunidad(\"Negocio en etapa inicial. Compartir guía educativa.\"); cerrarConversacion(); } else if (presupuesto_mensual < 500) { activarRutaComunidad(\"Presupuesto menor a $500 USD. Compartir guía educativa.\"); cerrarConversacion(); } else if (negocio_activo && presupuesto_mensual >= 500 && interes_crecimiento === \"ALTO\") { proponerLlamadaEstrategica(\"Meet de diagnóstico de 15 minutos.\"); agendarConEquipoHumano(); } else if (evasion_preguntas >= 2) { cerrarConversacion(\"Cierre profesional por falta de datos para diagnóstico.\"); }",
    "contentTruncated": false,
    "search": {
      "id": "15-logica-decision",
      "slug": "comercial/logica-decision",
      ...
      "description": "arbol de decision, variables criticas de evaluacion, reglas de persistencia, condiciones de terminacion y restricciones operativas absolutas para la integracion del agente comercial ia.",
      "category": "tecnologia",
      "audience": "empresas",
      "keywords": [
        "logica de decision",
      ...
      "content": "logica de decision y reglas operativas (sdr automatizado)documento de especificacion tecnica y logica de decision para la orquestacion del agente comercial ia de 77 studio sas en entornos de ejecucion automatizados (n8n + gemini / eve runtime).1. principio operativo generalel sistema opera bajo una regla de triaje binaria:si cumple con los criterios minimos: conducir hacia el agendamiento de una llamada estrategica por meet con el equipo de consultoria humana.si no cumple con los criterios minimos: activar el protocolo de ruta de comunidad (guia educativa descargable) y cerrar la conversacion cordialmente.2. variables criticas de evaluacionel motor de decision evalua obligatoriamente las siguientes variables booleanas:| variable | tipo | condicion de aprobacion | | :--- | :--- | :--- | | negocio_activo | booleano | si (operando actualmente). | | ha_vendido_antes | booleano | si (producto/servicio probado). | | presupuesto_minimo | booleano | si (dispone de ≥ $500 usd / $2.000.000 cop mensuales en honorarios). | | capacidad_operativa | booleano | si (equipo disponible para responder prospectos). | | interes_crecimiento | enum | alto (busca escalar y estructurar su captacion). |3. arbol de decision principalcaso a: negocio no activo / en etapa de ideacondicion: negocio_activo == no o ha_vendido_antes == no.accion: no agendar llamada. redirigir a recurso educativo. cerrar conversacion con profesionalismo.caso b: presupuesto insuficiente (< $500 usd)condicion: presupuesto_minimo == no (confirma presupuesto menor a $500 usd / $2m cop).accion: no negociar, no ofrecer descuentos ni tarifas reducidas. activar ruta de comunidad y compartir guia descargable.caso c: negocio activo + presupuesto elegible (calificado)condicion: negocio_activo == si && presupuesto_minimo == si && interes == alto.accion: confirmar intencion, proponer agendamiento por meet, solicitar disponibilidad horaria y formalizar la cita con el equipo de 77 studio.caso d: evasion de preguntas de diagnosticocondicion: el prospecto evita responder las preguntas de calificacion o solo insiste en pedir precios sin contexto.accion: reintentar el diagnostico un maximo de 2 veces. si persiste la evasion, cerrar la conversacion amablemente sin agendar.caso e: objecion por malas experiencias pasadascondicion: el prospecto manifiesta desconfianza o malas experiencias con agencias anteriores.accion: validar la preocupacion con empatia, explicar brevemente el enfoque de medicion y acompanamiento de 77 studio, y retomar el flujo de calificacion.4. reglas de persistencia y limites de interaccionreintentos permitidos: reformular una pregunta clave un maximo de 2 veces si la respuesta no es clara.limite de inactividad: no enviar mas de 2 mensajes consecutivos si el prospecto no responde.sin presion: jamas insistir ni rogar por un agendamiento.5. condiciones de terminacion de la conversacionel agente finaliza formalmente la interaccion cuando:se concreta el agendamiento de la reunion estrategica.se entrega el recurso educativo de la ruta de comunidad.el prospecto deja de responder tras 2 intentos de seguimiento.el prospecto confirma explicitamente que no desea continuar.6. restricciones operativas absolutasel agente tiene prohibido:❌ garantizar ventas, contratos cerrados o prometer retorno de inversion (roi) fijo.❌ discutir precios finales cerrados sin previo diagnostico del equipo humano.❌ negociar o rebajar los honorarios minimos de $500 usd.❌ enviar propuestas formales o contratos legales.❌ extender conversaciones no comerciales fuera del alcance de 77 studio.7. pseudocodigo operativo del motor de decisionif (!negocio_activo || !ha_vendido_antes) { activarrutacomunidad(\"negocio en etapa inicial. compartir guia educativa.\"); cerrarconversacion(); } else if (presupuesto_mensual < 500) { activarrutacomunidad(\"presupuesto menor a $500 usd. compartir guia educativa.\"); cerrarconversacion(); } else if (negocio_activo && presupuesto_mensual >= 500 && interes_crecimiento === \"alto\") { proponerllamadaestrategica(\"meet de diagnostico de 15 minutos.\"); agendarconequipohumano(); } else if (evasion_preguntas >= 2) { cerrarconversacion(\"cierre profesional por falta de datos para diagnostico.\"); }"
    }
  }
];
